...
void handleRoot() {
  ...
  html += "h1 { color: #000000ff; font-size: 28px; margin-bottom: 20px; }";
  html += "p { color: #1f1f1fff; font-size: 18px; margin: 10px 0; }";
  html += ".button { background: #4c6fafff; border: none; color: white; padding: 12px 24px; text-decoration: none; font-size: 20px; border-radius: 8px; cursor: pointer; transition: background 0.2s ease; display: inline-block; width: 120px; box-sizing: border-box; }";
  html += ".button:hover { background: #5983cfff; }";
  ...
  html += "<p>GPIO 8 - State " + outputState + "</p>";
  if (outputState == "ON") {
